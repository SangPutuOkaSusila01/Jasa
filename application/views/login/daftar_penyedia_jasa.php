                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Buat akun Penyedia jasa!</h1>
                                        <?php echo $this->session->flashdata('pesan'); ?>
                                    </div>
                                    <form class="user"
                                        action="<?php echo base_url('login/proses_daftar_penyedia_jasa') ?>"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <?php 
                                                $list=array('Pilih jasa');
                                                foreach($list_daftar_jasa as $value)
                                                    {
                                                        $list[$value->jenis_jasa] = $value->nama_jasa;
                                                    }
                                                    echo form_dropdown('jenis_jasa',$list,'',"class='custom-select input-full required'");    
                                                ?>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="kisaran_harga" class="form-control"
                                                id="exampleInputEmail" placeholder="Kisaran harga" required>
                                        </div>
